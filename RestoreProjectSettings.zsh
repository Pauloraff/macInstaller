...
# sample invocation
# SIGNINGCERT="Developer ID Application: Paulo Raffaelli (2XEVFK8ZST)" CLIENTNAME="com.greenkitty.macinstaller" HELPERNAME="com.greenkitty.macinstallerhelper" COMPANYMAME="Green Kitty" ./RestoreProjectSettings.zsh
