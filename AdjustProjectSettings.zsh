...
# key 'HELPERNAME'
# value 'identifier "HELPERNAME" and anchor apple generic and certificate leaf[subject.CN] = "SIGNINGCERT"'
...
# macInstallerHelper launchd.plist
# key Label
# value 'HELPERNAME'
...
cp -r "macInstaller/HELPERNAME/" "macInstaller/$HELPERNAME/" 
